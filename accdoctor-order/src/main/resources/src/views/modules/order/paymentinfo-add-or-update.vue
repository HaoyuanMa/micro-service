<template>
  <el-dialog
    ...
    <el-form-item label="交易内容" prop="subjectContent">
      <el-input v-model="dataForm.subjectContent" placeholder="交易内容"></el-input>
    </el-form-item>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.subjectContent = data.paymentInfo.subjectContent
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'subjectContent': this.dataForm.subjectContent,
